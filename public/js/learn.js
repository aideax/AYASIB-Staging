...
let showQuestions = async () => {
    ...
    async function loadComments() {
        ...
        let comments = []
        try{
            const res = await axios.get(`http://localhost:5500/comments/${id}`)
            console.log(res)
    ...
    function clear() {
        if(DOM.username){
            console.log(DOM.username.textContent)
        } else{
